...
class Solution:
    def calculateMinimumHP(self, dungeon: List[List[int]]) -> int:
        ...
        # returns list of tuples (max_loss, gain) to get to (i, j)
        @lru_cache(None)
        def solver(i, j) -> List[Tuple[int, int]]:
            cur = dungeon[i][j]
